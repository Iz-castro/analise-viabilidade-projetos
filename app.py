...
if uploaded_file:
    ...
    if st.button("Treinar com novos dados"):
        try:
            ...
            # Salvar novo modelo atualizado
            joblib.dump(modelo, "logistic_model_atualizado.joblib")

            st.success("✅ Modelo atualizado com sucesso e salvo como 'logistic_model_atualizado.joblib'.")
